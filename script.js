...
const positions = [
    "TI", // PosiciÃ³n de portero
    "Recursos Humanos", // PosiciÃ³n de defensa central
    "Marketing", // PosiciÃ³n de lateral derecho
    "Supervisor de Calidad", // PosiciÃ³n de lateral izquierdo
    "Help Desk", // PosiciÃ³n de mediocampista defensivo
    "Client Customer", // PosiciÃ³n de mediocampista ofensivo
    "Ventas", // PosiciÃ³n de extremo derecho
    "Recepción", // PosiciÃ³n de extremo izquierdo
    "Cartera" // PosiciÃ³n de delantero centro
];
...
function loadPositions() {
    ...
    positionSelect.innerHTML = `<option value="">Seleccione un rol</option>`; // Agrega la opciÃ³n predeterminada
...
teamForm.addEventListener("submit", e => {
    ...
    if (!name) {
        alert("Por favor, ingrese el nombre de la empresa."); // Muestra un mensaje si el nombre estÃ¡ vacÃ­o
...
function updatePlayerTable() {
    ...
    players.forEach(player => {
        const row = `<tr>
            ...
            <td>${player.name}</td> <!-- Nombre del empleado -->
            <td>${player.age}</td> <!-- Edad del empleado -->
            <td>${player.position}</td> <!-- Rol del empleado -->
            <td>${player.team}</td> <!-- Empresa del jugador -->
        </tr>`;
